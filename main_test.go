...
const resultTest = "#TYPE nginx_request_time_seconds_avg gauge\nnginx_request_time_seconds_avg{path=\"/global/about/press/science-based-targets-initiative-7498\",method=\"GET\",status=\"200\"} 0.046\n"
const resultTest2 = "#TYPE nginx_request_time_seconds_avg gauge\nnginx_request_time_seconds_avg{path=\"/global/about/press/science-based-targets-initiative-7498\",method=\"GET\",status=\"200\"} 0.059\n#TYPE nginx_request_time_seconds_avg gauge\nnginx_request_time_seconds_avg{path=\"/global/about/press/science-based-targets-initiative-7498\",method=\"GET\",status=\"200\"} 0.062\n"
